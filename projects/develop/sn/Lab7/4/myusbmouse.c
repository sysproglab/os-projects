...
#define DRIVER_AUTHOR "Shalyapin Nikita"
...
int getBtnRightCounter( void )
{
	return btn_right_counter;
}
EXPORT_SYMBOL( getBtnRightCounter ); 
int getBtnLeftCounter( void )
{
	return btn_left_counter;
}
EXPORT_SYMBOL( getBtnLeftCounter ); 
